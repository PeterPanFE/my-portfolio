...
const hero = {
  salutations: "Hi, I'm ",
  my_short_description: "I develop React Applications for web and mobile, as well as 3D visuals and user interfaces."
}

const about = {
  description: "I'm a skilled software developer with experience in TypeScript ans JavaScript, and expertise in frameworks like React, Node.js, and Three.js. I'm a quick learner and collaborate closely with clients to create edfficient, scalable, and user-friendly solutions that solve real-world problems. Let's work together to bring your ideas to life!"
}

const works = {
  description: "Following projects showcases my skills and experience\
...
export { hero, about, works, services, technologies, experiences, testimonials, projects, my_global_info };